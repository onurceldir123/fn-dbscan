...
```bash
git clone https://github.com/username/fn-dbscan.git
cd fn-dbscan
pip install -e .
```
...
If you encounter any issues or have questions, please [open an issue](https://github.com/username/fn-dbscan/issues) on GitHub.
